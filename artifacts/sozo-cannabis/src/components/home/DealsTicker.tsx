...
export function DealsTicker() {
  ...
  return (
    <div
      ...
      style={{ background: "var(--bg-moss)", borderTop: "1px solid var(--border-dark)", borderBottom: "1px solid var(--border-dark)", height: 52 }}
    >
      {/* Left label */}
      <div
      ...
      <Link href="/products">
        <button
          ...
          className="absolute right-0 h-full px-6 text-xs tracking-[0.15em] uppercase whitespace-nowrap transition-opacity hover:opacity-70"
          style={{
